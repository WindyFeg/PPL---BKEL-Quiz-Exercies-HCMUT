...
class BKOOLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKOOLParser#operat.
    def visitOperat(self, ctx:BKOOLParser.OperatContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKOOLParser#operan.
    def visitOperan(self, ctx:BKOOLParser.OperanContext):
        return self.visitChildren(ctx)
